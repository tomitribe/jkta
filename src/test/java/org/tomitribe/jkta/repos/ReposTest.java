...
public class ReposTest extends Assert {
    ...
    public void list() throws Exception {
        ...
        assertEquals("git@github.com:eclipse-ee4j/authentication.git\n" +
                "git@github.com:eclipse-ee4j/authorization.git\n" +
                "git@github.com:eclipse-ee4j/batch-api.git\n" +
                "git@github.com:eclipse-ee4j/batch-tck.git\n" +
                "git@github.com:eclipse-ee4j/beanvalidation-api.git\n" +
                "git@github.com:eclipse-ee4j/beanvalidation-spec.git\n" +
                "git@github.com:eclipse-ee4j/beanvalidation-tck.git\n" +
                "git@github.com:eclipse-ee4j/bvtck-porting.git\n" +
                "git@github.com:eclipse-ee4j/cargotracker.git\n" +
                "git@github.com:eclipse-ee4j/cdi-tck.git\n" +
                "git@github.com:eclipse-ee4j/cdi.git\n" +
                ...
                "git@github.com:eclipse-ee4j/faces-api.git\n" +
                ...
                "git@github.com:eclipse-ee4j/glassfish-docs.git\n" +
                ...
                "git@github.com:eclipse-ee4j/glassfish-samples.git\n" +
                ...
                "git@github.com:eclipse-ee4j/injection-api.git\n" +
                "git@github.com:eclipse-ee4j/injection-spec.git\n" +
                "git@github.com:eclipse-ee4j/injection-tck.git\n" +
                ...
                "git@github.com:eclipse-ee4j/jakartaee-examples.git\n" +
                ...
                "git@github.com:eclipse-ee4j/jakartaee-release.git\n" +
                ...
                "git@github.com:eclipse-ee4j/mail-spec.git\n" +
                "git@github.com:eclipse-ee4j/mail-tck.git\n" +
                "git@github.com:eclipse-ee4j/mail.git\n" +
                ...
                "git@github.com:eclipse-ee4j/starter.git\n" +
