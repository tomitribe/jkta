...
public class Usage<Context> implements Predicate<String> {
    ...
    public static class Mutable<Context> {
        ...
        private Mutable(final Usage<Context> usage) {
            this.usage = usage;
        }
        ...
        public <NewContext> Usage<NewContext> get(final NewContext context) {
            return new Usage<>(context, usage.javax, usage.jakarta, usage.packages);
        }
    ...
    public static class Builder {
        ...
        public <Context> Usage<Context> build(final Context context) {
            ...
            return new Usage<>(context, javax, jakarta, packages);
        }
    }
}
